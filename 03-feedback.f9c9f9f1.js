...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const a={form:document.querySelector(".feedback-form"),email:document.querySelector(".feedback-form input"),message:document.querySelector(".feedback-form textarea"),submitBtn:document.querySelector(".feedback-form button")};a.submitBtn.addEventListener("click",r),a.form.addEventListener("input",(0,e.default)(m,500));const o="feedback-form-state";function r(e){e.preventDefault(),a.form.reset(),localStorage.removeItem(o)}function m(e){const t={mail:formElements.email.value,message:formElements.message.value};localStorage.setItem(o,JSON.stringify(t))}function s(){const e=JSON.parse(localStorage.getItem(o));(a.email||""===a.message)&&(a.email.value=e.mail,a.message.value=e.message)}s();
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.f9c9f9f1.js.map