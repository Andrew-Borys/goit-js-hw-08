...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const o={form:document.querySelector(".feedback-form"),email:document.querySelector(".feedback-form input"),message:document.querySelector(".feedback-form textarea"),submitBtn:document.querySelector(".feedback-form button")};o.submitBtn.addEventListener("click",r,l),o.form.addEventListener("input",(0,e.default)(l,500));const a="feedback-form-state";function r(e){e.preventDefault(),o.form.reset(),console.log(JSON.parse(localStorage.getItem(a))),localStorage.removeItem(a)}function l(e){const t={mail:o.email.value,message:o.message.value};localStorage.setItem(a,JSON.stringify(t))}function c(){const e=JSON.parse(localStorage.getItem(a));e&&(o.email.value=e.mail,o.message.value=e.message)}c();
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.f1383251.js.map